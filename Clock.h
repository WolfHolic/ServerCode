...
#define DATATIME_FORMAT				L"D%Y-%m-%dT%H:%M:%S"
...
class Clock : public Singleton<Clock>
{
	...
	wstr_t							tickToStr(tick_t tick, WCHAR *fmt = DATATIME_FORMAT);
...
public:
	...
	wstr_t							nowTime(WCHAR *fmt = DATATIME_FORMAT);
	wstr_t							nowTimeWithMilliSec(WCHAR *fmt = DATATIME_FORMAT);
